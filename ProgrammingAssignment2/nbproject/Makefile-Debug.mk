...
LDLIBSOPTIONS=../MemorySubsystem/dist/Release/GNU-Linux/libmemorysubsystem.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingassignment2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingassignment2: ../MemorySubsystem/dist/Release/GNU-Linux/libmemorysubsystem.a
...
# Subprojects
.build-subprojects:
	cd ../MemorySubsystem && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../MemorySubsystem && ${MAKE}  -f Makefile CONF=Release clean
