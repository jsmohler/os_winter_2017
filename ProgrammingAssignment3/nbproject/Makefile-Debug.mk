...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingassignment3

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingassignment3: ../MemorySubsystem/dist/Debug/GNU-Linux/libmemorysubsystem.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingassignment3: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programmingassignment3 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Scheduler.o: Scheduler.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MemorySubsystem -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scheduler.o Scheduler.cpp
...
${OBJECTDIR}/Scheduler_nomain.o: ${OBJECTDIR}/Scheduler.o Scheduler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../MemorySubsystem -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scheduler_nomain.o Scheduler.cpp;\
	else  \
